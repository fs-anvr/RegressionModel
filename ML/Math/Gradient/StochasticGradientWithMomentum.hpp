...
#ifndef ML_LINEARREGRESSION_STOCHASTICGRADIENTWITHMOMENTUM_HPP
#define ML_LINEARREGRESSION_STOCHASTICGRADIENTWITHMOMENTUM_HPP
...
namespace ML::Math {
    ...
    class StochasticGradientWithMomentum : public IGradient {
    public:
    ...
    using SAGM = StochasticGradientWithMomentum;

}

#endif //ML_LINEARREGRESSION_STOCHASTICGRADIENTWITHMOMENTUM_HPP
